 ...
 * GameRepository
 */
class GameRepository extends EventEmitter {
    constructor(client, parent, sound, notifier) {
        super();
    ...
    onProperty(e) {
        const data = e.detail;
        const avatar = this.game.avatars.getById(data[0]);
     ...
     */
    onBonusClear(e) {
        const bonus = this.game.bonusManager.bonuses.getById(e.detail);
